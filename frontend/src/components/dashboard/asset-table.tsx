...
interface Asset {
  ...
  dividendYield?: number | null; // FASE 136: Dividend Yield %
}
...
type SortColumn = 'ticker' | 'name' | 'sector' | 'price' | 'changePercent' | 'dividendYield' | 'volume' | 'marketCap';
