...
export function DashboardPageClient() {
  ...
  // Tratar !hydrated como loading para renderizacao consistente server/client
    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-muted-foreground">
          Visao geral do mercado e do seu portfolio
        </p>
      </div>
      ...
      {/* Indicadores Economicos (SELIC, IPCA, CDI) - FASE 1 */}
      <EconomicIndicators />

      {/* Termometro do Mercado + Calendario Economico + Indices - FASE 75 */}
      <div className="grid gap-4 md:grid-cols-3">
        {/* Termometro do Mercado (Sentimento) - 1 coluna */}
        <MarketThermometer />

        {/* Calendario Economico - 1 coluna */}
        <EconomicCalendarWidget />

        {/* Painel de Indices em Destaque - 1 coluna */}
        <MarketIndices />
      </div>
